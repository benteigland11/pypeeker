...
Install `pypeeker` globally using `pip`:

```bash
pip install pypeeker
```
...
pypeeker is built to be a native plugin for AI agents using the **Model Context Protocol (MCP)**.
...
*   **Cursor & Roo Code**: `.cursor/mcp.json` (Auto-detected)
